...
export const config = {
    ...
    database: {
        ...
        slaves: [
            {
                host: process.env.DB_HOSTNAME_SLAVE1,
                port: +(process.env.DB_PORT_SLAVE1 || "3307"),
                username: process.env.DB_USERNAME_SLAVE1,
                password: process.env.DB_PASSWORD_SLAVE1,
                database: process.env.DB_DATABASE_SLAVE1,
            },
            {
                host: process.env.DB_HOSTNAME_SLAVE2,
                port: +(process.env.DB_PORT_SLAVE2 || "3307"),
                username: process.env.DB_USERNAME_SLAVE2,
                password: process.env.DB_PASSWORD_SLAVE2,
                database: process.env.DB_DATABASE_SLAVE2,
            },
        ]
    },
    ...
    calculation: {
         ...
         * 0.0001% = 0.000001 = 1
         */
        percentageWei: +(process.env.MAX_FEE_PERCENTAGE || "1") / 100 || 10000,
